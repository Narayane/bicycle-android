...
object StateShowContracts : SBState()
object StateShowStations : SBState()

object EventOutOfAnyContract : SBEvent()
data class EventNewContract(val current: BICContract) : SBEvent()
object EventSameContract : SBEvent()
data class EventContractList(val contracts: List<BICContract>) : SBEvent()
data class EventStationList(val stations: List<BICStation>) : SBEvent()
