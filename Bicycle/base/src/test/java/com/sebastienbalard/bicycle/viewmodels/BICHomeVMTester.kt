...
class BICHomeVMTester {
    ...
    private val contractToulouse = BICContract(1, "Toulouse", 43.604652, 1.444209, BICContract.Provider.CityBikes, 6000.0, "https://")
    private val contractParis = BICContract(2, "Paris", 48.856614, 2.3522219, BICContract.Provider.CityBikes, 10000.0, "https://")
    private val contractColomiers = BICContract(3, "Colomiers", 43.610580, 1.334670, BICContract.Provider.CityBikes, 2000.0, "https://")
    private val contractBassoCambo = BICContract(4, "Basso Cambo", 43.570932, 1.392268, BICContract.Provider.CityBikes, 250.0, "https://")
